...
public class TC04_ChuTich_PhanCongThucHien extends ThuocTinhVBDen {
	WebDriver driver;
	String trich_yeu = "TC 04 - Chủ tịch - Kiểm tra Chủ tịch Phân công thực hiện VB được tạo lúc: " + createdTime;
