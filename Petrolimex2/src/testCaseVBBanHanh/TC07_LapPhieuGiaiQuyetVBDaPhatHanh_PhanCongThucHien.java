...
public class TC07_LapPhieuGiaiQuyetVBDaPhatHanh_PhanCongThucHien extends ThuocTinhVBBanHanh {
	WebDriver driver;
...
public void LapPhieuGiaiQuyetVBDaPhatHanh() throws InterruptedException {
	...
	danhSachViecCanXuLy.ClickOnFirstItem();
	formTaskVanDi.CheckAllNhanVien();
	formTaskVanDi.PhanCong(y_kien_nguoi_nhan);
	login.signOut();
	login.LoginNvienThucHien();
	danhSachViecCanXuLy.ValidateTaskXuLyVanBanDi(trich_yeu, lanh_dao_phong_ban);
	danhSachViecCanXuLy.ClickOnFirstItem();
