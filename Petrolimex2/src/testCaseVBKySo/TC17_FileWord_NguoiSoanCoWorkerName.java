...
public class TC17_FileWord_NguoiSoanCoWorkerName extends ThuocTinhVBDuThao {
	WebDriver driver;
// Format Simple Date
	String trich_yeu = "[VTTest] TC 17 - File Word - Người soạn thảo có WorkerName" + System.currentTimeMillis();
@Test
public void FileWord_NguoiSoanCoWorkerName() throws InterruptedException {
	...
	login.LoginNhanVienKhoiTaoKySoCoWN();
	...
	formVanBanDuThao.uploadFile(file_word_ky_so_3_chu_ky);
	...
	danhSachViecCanXuLy.ValidateTaskPheDuyetVbDuThaoKySo(trich_yeu, nguoi_tao_vb_ky_so_co_wn);
