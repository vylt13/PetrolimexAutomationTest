...
public class TC19_FileWord_KySoFileCoCommentTrackChange extends ThuocTinhVBDuThao {
	WebDriver driver;
// Format Simple Date
	String trich_yeu = "[VTTest] TC 19 - File Word - Có comment và TrackChange " + System.currentTimeMillis();
@Test
public void KySoFileCoCommentTrackChange() throws InterruptedException {
	...
	formVanBanDuThao.uploadFile(file_word_co_comment);
	formVanBanDuThao.uploadFile(file_word_co_trackchange);
