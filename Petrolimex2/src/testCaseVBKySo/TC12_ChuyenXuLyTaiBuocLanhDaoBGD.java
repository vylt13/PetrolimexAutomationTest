...
public class TC12_ChuyenXuLyTaiBuocLanhDaoBGD extends ThuocTinhVBDuThao {
	WebDriver driver;
// Format Simple Date
	String trich_yeu = "[VTTest] TC 11 - Chuyển xử lý tại bước Lãnh đạo Ban Giám đốc " + System.currentTimeMillis();
@Test
public void ChuyenXuLyTaiBuocLanhDaoBGD() throws InterruptedException {
...
//	Lanh dao Dong phe duyet duyet
	...
	danhSachViecCanXuLy.ValidateTaskChuyenXuLyPheDuyetVbDuThaoKySo(trich_yeu, lanh_dao_duyet_vb);
	danhSachViecCanXuLy.ClickOnFirstItem();
	...
	danhSachViecCanXuLy.ValidateTaskPhatHanhVBDuThaoDaPheDuyet(trich_yeu, user_chuyen_xu_ly_ky_so);
	danhSachViecCanXuLy.ClickOnFirstItem();
