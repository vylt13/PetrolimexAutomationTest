...
public class TC02_FileWord_KySoFile1Trang extends ThuocTinhVBDuThao {
	WebDriver driver;
// Format Simple Date
	String trich_yeu = "[VTTest] TC 02 Văn bản ký số 1 trang" + System.currentTimeMillis();
@Test
public void FileWord_KySoFile1Trang() throws InterruptedException {
