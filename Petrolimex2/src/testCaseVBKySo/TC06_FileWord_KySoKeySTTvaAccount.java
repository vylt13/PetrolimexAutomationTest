...
public class TC06_FileWord_KySoKeySTTvaAccount extends ThuocTinhVBDuThao {
	WebDriver driver;
// Format Simple Date
	String trich_yeu = "[VTTest] TC 06 - File Word - Ký số file key STT và Account " + System.currentTimeMillis();
@Test
public void FileWord_KySoKeySTTvaAccount() throws InterruptedException {
	...
	formVanBanDuThao.uploadFile(file_word_ky_so_ket_hop_key_stt_account);
