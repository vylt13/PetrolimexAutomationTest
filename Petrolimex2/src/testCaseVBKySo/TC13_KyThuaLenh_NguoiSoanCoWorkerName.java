...
public class TC13_KyThuaLenh_NguoiSoanCoWorkerName extends ThuocTinhVBDuThao {
	WebDriver driver;
// Format Simple Date
	String trich_yeu = "[VTTest] TC 13 - Ký thừa lệnh - Người soạn có WorkerName - Quy trình 2 Step duyệt " + System.currentTimeMillis();
@Test
