...
public class TC10_KySoLoiNhieuLoaiFile extends ThuocTinhVBDuThao {
	WebDriver driver;
// Format Simple Date
	String trich_yeu = "[VTTest] TC 10 - Ký số Lỗi Nhiều loại file " + System.currentTimeMillis();
@Test
public void VBDangLuuKhongDinhKem() throws InterruptedException {
	...
	formVanBanDuThao.uploadFile(file_word_ky_so_loi);
