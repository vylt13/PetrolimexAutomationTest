...
public class TC05_FileWord_KyNhayOBuocCuoiCung extends ThuocTinhVBDuThao {
	WebDriver driver;
// Format Simple Date
	String trich_yeu = "[VTTest] TC 06 - File Word - Ký nháy ở Bước cuối cùng " + System.currentTimeMillis();
@Test
public void VBDangLuuKhongDinhKem() throws InterruptedException {
	...
	formVanBanDuThao.uploadFile(file_word_ky_so_ky_nhay_o_buoc_cuoi_key_stt);
	formVanBanDuThao.uploadFile(file_word_ky_so_ky_nhay_o_buoc_cuoi_key_account);
