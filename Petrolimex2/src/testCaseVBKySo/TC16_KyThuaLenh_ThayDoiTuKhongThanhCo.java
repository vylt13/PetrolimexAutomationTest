...
public class TC16_KyThuaLenh_ThayDoiTuKhongThanhCo extends ThuocTinhVBDuThao {
	WebDriver driver;
// Format Simple Date
	String trich_yeu = "[VTTest] TC 16 - Ký thừa lệnh - Thay đổi từ Không thành Có ký thừa lệnh " + System.currentTimeMillis();
@Test
public void KyThuaLenh_ThayDoiTuKhongThanhCo() throws InterruptedException {
