...
public class TC04_FileWord_KySoFileWord extends ThuocTinhVBDuThao {
	WebDriver driver;
// Format Simple Date
	String trich_yeu = "[VTTest] TC 04 - File Word - Ký số nhiều file Word " + System.currentTimeMillis();
@Test
