...
public class TC03_NV_NVLapHoSoDuThao extends ThuocTinhVBDen {
	WebDriver driver;
	String trich_yeu = "TC 03 - Nhân viên - Kiểm tra Nhân viên Lập HSDT: " + createdTime;
...
@Test
public void NVLapHoSoDuThao() throws InterruptedException {
	...
	formTaskVanBanDen.LapHoSoDuThao(
			...
			filePath);
	formTaskVanBanDen.waitingForLoading();
	formTaskVanBanDen.ValidateLinkHoSoDuThao(trich_yeu_du_thao_vb);
	formTaskVanBanDen.MoPhieuGiaiQuyet();
	formXuLyVanBanDen.ValidateTinhTrangNhanVienLapHoSoDuThao(
			account_nv_thuc_hien, 
			trich_yeu_du_thao_vb);
	driver.quit();
	} 
}