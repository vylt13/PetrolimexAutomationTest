...
public class TC21_HoSoTaiLieuKhongKyMoc_LuongKyNhay extends ThuocTinhHoSoTaiLieu{
	WebDriver driver;
	String trich_yeu = "[VTTest] Hồ sơ tài liệu không ký mộc - Luồng ký nháy " + createdTime;
@Test
