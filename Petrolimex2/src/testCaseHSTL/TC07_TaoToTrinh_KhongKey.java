...
public class TC07_TaoToTrinh_KhongKey extends ThuocTinhHoSoTaiLieu{
	WebDriver driver;
	String trich_yeu = "[VTTest] Tờ trình Luồng ký số Tờ trình Không Key Ngày tháng năm tạo lúc: " + createdTime;
	String trich_yeu_edit = "[VTTest] Tờ trình Luồng ký số Tờ trình Không Key Ngày tháng năm Edit lúc: " + createdTime;
@Test
public void TaoToTrinh_KhongKey() throws InterruptedException {
	...
	formHoSoTaiLieu.uploadFile(file_totrinh_khong_key_ngay_thang_nam);
