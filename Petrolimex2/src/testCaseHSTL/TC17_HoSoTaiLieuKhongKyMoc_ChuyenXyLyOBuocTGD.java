...
public class TC17_HoSoTaiLieuKhongKyMoc_ChuyenXyLyOBuocTGD extends ThuocTinhHoSoTaiLieu{
	WebDriver driver;
	String trich_yeu = "[VTTest] Hồ sơ tài liệu không ký mộc - Chuyển xử lý ở bước TGD" + createdTime;
@Test
public void HoSoTaiLieuKhongKyMoc_ChuyenXyLyOBuocTGD() throws InterruptedException {
	...
	danhSachViecCanXuLy.ValidateTaskYeuCauPheDuyetToTrinh(trich_yeu, lanh_dao_bgd);
	danhSachViecCanXuLy.ClickOnFirstItem();
	formHoSoTaiLieu.InputYKienPheDuyet(y_kien_phe_duyet_hstl);
