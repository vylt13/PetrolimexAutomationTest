...
public class TC10_HoSoTaiLieuKyMoc_KeyUser extends ThuocTinhHoSoTaiLieu{
	WebDriver driver;
	String noi_dung_hop_dong = "[VTTest] Hồ sơ tài liệu ký Mộc - File Key User " + createdTime;
@Test
