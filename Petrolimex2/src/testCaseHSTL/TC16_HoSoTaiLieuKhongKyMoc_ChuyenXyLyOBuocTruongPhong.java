...
public class TC16_HoSoTaiLieuKhongKyMoc_ChuyenXyLyOBuocTruongPhong extends ThuocTinhHoSoTaiLieu{
	WebDriver driver;
	String trich_yeu = "[VTTest] Hồ sơ tài liệu không ký mộc - Chuyển xử lý ở bước Trưởng phòng" + createdTime;
@Test
public void HoSoTaiLieuKhongKyMoc_ChuyenXyLyOBuocTruongPhong() throws InterruptedException {
	...
	login.signOut();
	login.LoginUserTgd();
	danhSachViecCanXuLy.ValidateTaskYeuCauPheDuyetToTrinh(trich_yeu, user_phe_duyet_hstl);
	danhSachViecCanXuLy.ClickOnFirstItem();
	formHoSoTaiLieu.InputYKienPheDuyet(y_kien_phe_duyet_hstl);
