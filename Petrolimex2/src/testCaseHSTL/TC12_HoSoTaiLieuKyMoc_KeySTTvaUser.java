...
public class TC12_HoSoTaiLieuKyMoc_KeySTTvaUser extends ThuocTinhHoSoTaiLieu{
	WebDriver driver;
	String noi_dung_hop_dong = "[VTTest] Hồ sơ tài liệu ký Mộc - File Key STT và User " + createdTime;
@Test
public void HoSoTaiLieuKyMoc_KeySTTvaUser() throws InterruptedException {
