...
public class TC03_TaoToTrinhCoFileLoi extends ThuocTinhHoSoTaiLieu{
	WebDriver driver;
	String trich_yeu = "[VTTest] Tờ trình Luồng ký số có file lỗi: " + createdTime;
	String trich_yeu_edit = "[VTTest] Tờ trình Luồng ký số có file lỗi Edit lúc: " + createdTime;
@Test
public void TaoToTrinhCoFileLoi() throws InterruptedException {
