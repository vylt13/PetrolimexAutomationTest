...
public class TC03_TaoToTrinh extends ThuocTinhHoSoTaiLieu{
	WebDriver driver;
	String trich_yeu = "[VTTest] Tờ trình Luồng ký số bình thường tạo lúc: " + createdTime;
	String trich_yeu_edit = "[VTTest] Tờ trình Luồng ký số bình thường Edit lúc: " + createdTime;
@Test
public void TaoToTrinh() throws InterruptedException {
	...
	formHoSoTaiLieu.uploadFile(file_totrinh_ky_so);
	...
	formThemMoiHopDong.ValidateThongTinFormSuaToTrinh(
			so_van_ban, 
			don_vi_soan_thao, 
			trich_yeu, 
			ngay_ky, 
			...
			noi_luu, 
			ho_so_luu_tru);
	formThemMoiHopDong.editToTrinh(
			so_van_ban_edit, 
			trich_yeu_edit, 
			ngay_ky_edit, 
			noi_luu_edit, 
