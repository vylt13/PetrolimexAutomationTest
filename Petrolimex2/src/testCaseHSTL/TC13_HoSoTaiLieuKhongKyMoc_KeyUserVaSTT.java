...
public class TC13_HoSoTaiLieuKhongKyMoc_KeyUserVaSTT extends ThuocTinhHoSoTaiLieu{
	WebDriver driver;
	String trich_yeu = "[VTTest] Hồ sơ tài liệu không ký mộc - File Key User và STT " + createdTime;
@Test
public void HoSoTaiLieuKhongKyMoc2_KeyUserVaSTT() throws InterruptedException {
	...
	formHoSoTaiLieu.uploadFile(file_hstl_2_key_user_va_stt);
