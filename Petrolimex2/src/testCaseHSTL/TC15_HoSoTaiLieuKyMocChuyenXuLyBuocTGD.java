...
public class TC15_HoSoTaiLieuKyMocChuyenXuLyBuocTGD extends ThuocTinhHoSoTaiLieu{
	WebDriver driver;
	String noi_dung_hop_dong = "[VTTest] Hồ sơ tài liệu ký Mộc - Chuyển xử lý ở Bước Giám đốc " + createdTime;
@Test
public void HoSoTaiLieuKyMocChuyenXuLyBuocTruongPhong() throws InterruptedException {
	...
	danhSachViecCanXuLy.ValidateTaskYeuCauPheDuyetHopDong(noi_dung_hop_dong, lanh_dao_bgd);
	danhSachViecCanXuLy.ClickOnFirstItem();
	formHoSoTaiLieu.InputYKienPheDuyet(y_kien_phe_duyet_hstl);
