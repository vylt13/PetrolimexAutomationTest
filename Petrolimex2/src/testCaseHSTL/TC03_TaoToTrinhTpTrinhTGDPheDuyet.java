...
public class TC03_TaoToTrinhTpTrinhTGDPheDuyet extends ThuocTinhHoSoTaiLieu{
	WebDriver driver;
	String trich_yeu = "[VTTest] Tờ trình Luồng ký số TP trình TGD phê duyệt: " + createdTime;
	String trich_yeu_edit = "[VTTest] Tờ trình Luồng ký số TP trình TGD phê duyệt Edit lúc: " + createdTime;
@Test
public void TaoBienBanThanhToan() throws InterruptedException {
	...
	danhSachVBDuThaoDangSoan.ValidateVBDangSoan(trich_yeu, "Tờ trình", lanh_dao_pb);
